...
// 注意：请使用AddUserForMutipleInstanceTask执行会签加签，本类的方法有bug，可以正常加签，但会签工作流程整体结束后，重新开工作待办人出现错误
public class AddUserForParallelTaskBak implements Command {
    // 会签内部流程变量
    ...
    public AddUserForParallelTaskBak(String multiRootExecutionId, String addUserTaskAssign) {
