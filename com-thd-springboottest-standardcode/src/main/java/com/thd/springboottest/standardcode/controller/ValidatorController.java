...
public class ValidatorController {
     ...
     * }
     */
    public ResponseEntity test(@RequestBody @Valid com.thd.springbootidtest.standardcode.bean.User user, BindingResult bindingResult){
     ...
     * }
     */
    public ResponseEntity test02(@RequestBody @Valid com.thd.springbootidtest.standardcode.bean.User user){
